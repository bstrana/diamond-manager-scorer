...
const BatterLowerThirdsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // This is important because OBS browser sources often don't receive BroadcastChannel messages
  ...
  return (
    <div className={`min-h-screen ${useGreenScreen ? 'bg-[#00b140]' : 'bg-transparent'}`}>
      ...
      <div className="w-full h-full">
        <BatterLowerThirds gameState={gameState} />
      </div>
    </div>
  );
};

export default BatterLowerThirdsPage;
